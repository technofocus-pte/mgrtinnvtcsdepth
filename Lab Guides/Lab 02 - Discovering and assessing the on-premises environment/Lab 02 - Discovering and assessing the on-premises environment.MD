# Lab 02 - Discovering and assessing the on-premises environment.
...
2.  In search bar type `resource groups` and select **Resource Groups**

    ![](./media/image2a.png)

2. Click on **+ Create** button, the provide the name as `AzureMigrateRG` and Region should be **West US**, click on the **Review + create** button.
...
5.  Select the resource group named **AzureMigrateRG**
...
3.  In **1: Generate project key**,
    provide `SHAppl@lab.LabInstance.Id` as name for the Azure Migrate appliance that you will set up
...
13. Open the Chrome browser on the **SmartHotelHost** VM and paste the
    copied link `https://go.microsoft.com/fwlink/?linkid=2191848`for the Azure Migrate appliance from the Notepad, it
...
generated](./media/image58.png)
    ...
    > **Note** - if you receive the below notification, it can be ignored.
...
21. In **Azure Migrate** page in **Servers, database and web
    ...
    ![A screenshot of a computer Description automatically
generated](./media/image126a.png)

22. Under **Manage**, select **Appliances**. and the click on **SHAppl@lab.LabInstance.Id**.

    ![A screenshot of a computer Description automatically
generated](./media/image127a.png)


23. Click on the **Refresh services** button, then Wait for the refresh operation to complete. You should now see
